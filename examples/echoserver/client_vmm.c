...
{
    /* sddf_timer_set_timeout(timer_config.driver_id, 1 * NS_IN_MS); */
    sddf_timer_set_timeout(timer_config.driver_id, 500 * NS_IN_US);
}
...
void notified(microkit_channel ch)
{
    ...
    if (ch == serial_config.rx.id) {
        ...
        struct virtio_device *dev = &virtio_net.virtio_device;
